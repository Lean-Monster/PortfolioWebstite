...
export default function projectSection(){
    ...
    return (
        <div className="flex items-center justify-center w-full" id="projects">
            <div className="w-full pt-10 md:mr-10 md:ml-40">
                <h1 className="text-3xl md:text-4xl font-bold text-[#b8dbd9] pb-4 ml-5 md:ml-0">/My Projects</h1>
                <h2 className="ml-5 text-xl md:ml-0 md:text-2xl">/WIP</h2>
                ...
                <h2 className="ml-5 text-xl md:text-2xl md:ml-0">/Completed</h2>
                    <div>
